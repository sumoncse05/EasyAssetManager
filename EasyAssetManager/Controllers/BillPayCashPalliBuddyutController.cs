...
{
    public class BillPayCashPalliBuddyutController : BaseController
    {
        private readonly IBillPayCashPalliBuddyutManager billPayCashManager;
        private IHostingEnvironment environment;
        private readonly IHttpContextAccessor contextAccessor;
        public BillPayCashPalliBuddyutController(IBillPayCashPalliBuddyutManager billPayCashManager, IHostingEnvironment environment, IHttpContextAccessor contextAccessor)
        {
            this.billPayCashManager = billPayCashManager;
            this.environment = environment;
            this.contextAccessor = contextAccessor;
        }
        [ScreenPermission("60123")]
